...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Department, Department> tblColumnEDIT;

	@FXML
	private TableColumn<Department, Department> tblColumnREMOVE;
	...
	public void updateTableView() {
		...
		tblViewDepartment.setItems(obsList);
		initEditButtons();
		initRemoveButtons();
	}
	...
	private void initEditButtons() {
		...
		tblColumnEDIT.setCellFactory(param -> new TableCell<Department, Department>() {
	...
	private void initRemoveButtons() {
		...
		tblColumnREMOVE.setCellFactory(param -> new TableCell<Department, Department>() {
