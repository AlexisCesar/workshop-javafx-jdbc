...
public class SellerFormController implements Initializable {
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		lblNameError.setText(fields.contains("name") ? errors.get("name") : null);
		
		lblEmailError.setText(fields.contains("email") ? errors.get("email") : null);
		
		lblBirthDateError.setText(fields.contains("birthDate") ? errors.get("birthDate") : null);
		
		lblBaseSalaryError.setText(fields.contains("baseSalary") ? errors.get("baseSalary") : null);
